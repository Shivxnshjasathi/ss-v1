...
class ChatListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Messages', style: TextStyle(color: context.primaryTextColor, fontWeight: FontWeight.w900)),
        backgroundColor: context.scaffoldColor,
        elevation: 0,
        centerTitle: false,
      ),
      body: userAsync.when(
        data: (user) {
          if (user == null) return const Center(child: Text('Please login to view messages.'));
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('No conversations yet', style: TextStyle(color: context.secondaryTextColor, fontWeight: FontWeight.w500)),
                    ],
                  ),
                );
              }
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    chat.lastMessageSenderId == user.uid ? 'You: ${chat.lastMessage}' : chat.lastMessage,
                                    maxLines: 1,
