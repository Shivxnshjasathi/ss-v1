                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(query.details['notes'] ?? query.category, style: TextStyle(color: context.secondaryTextColor, fontSize: 12.sp, height: 1.5), maxLines: 2, overflow: TextOverflow.ellipsis),
                                    SizedBox(height: 20.h),
                                    Row(
                                      children: [
                                        Expanded(
